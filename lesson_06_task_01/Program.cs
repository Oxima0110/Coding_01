// QuickSort
// 1. arr = {1, 0, -6, 2, 5, 3, 2} 
// 2. pivot = arr[6]  (опорный элемент выбирают первый или последний элемент)
// все элементы меньше опорного надо поставить слева, а элементы большие поставить правее
